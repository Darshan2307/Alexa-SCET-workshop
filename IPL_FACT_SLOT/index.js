...
const GetScheduleIntentHandler={
    ...
    handle(handlerInput){
        ...
        const date=handlerInput.requestEnvelope.request.intent.slots.MatchDate.value;
        const len=Schedule.matches.length;
        const matches=Schedule.matches;
        var say;
        
        for(var i=0;i<len;i++){
            if(matches[i].date==date){
                say= `<speak><say-as interpret-as="interjection">balle balle</say-as>.The match is ${matches[i].home} versus ${matches[i].away} </speak>`
...
const GetIplFactIntentHandler={
    ...
    canHandle(handlerInput){
        ...
        return handlerInput.requestEnvelope.request.type==='IntentRequest'
                && handlerInput.requestEnvelope.request.intent.name==='GetFavIplFactIntent';
    ...
    handle(handlerInput){
        ...
        const team=attr.favTeam;
        console.log(team);
        
        const say=Facts.TEAM_FACTS[team][index];
